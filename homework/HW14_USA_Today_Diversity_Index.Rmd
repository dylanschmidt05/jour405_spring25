...
Baltimore city stands out to me as the most diverse city because it has the highest 2 plus races score compared to any of the other Maryland cities. The population of all the different races is also significanly higher than the others shown. 
...
Summerfield has the highest race probability which makes the most sense because the majority of its population is black people. Of the 12,403 people in the city, 11,565 of them are black, meaning that there is a high chance if you randomly select two people, they will both be black.
...
The biggest thing I notice about the cities with the lowest Hisp_Prob scores is that those places are towards the bottom in terms of the Race_Prob. This means that these cities are quite diverse and have a high amount of people of each of the different races in their population.
...
The top three cities are Langley Park, Wheaton and Adelphi which are all places relatively close to College Park and two of the three are located within Prince George's County. The least diverse city is Lake Shore which is located in Anne Arundel County.
...
Langley Park and Adelphi help Prince George's County rank as Maryland's most diverse destination

Prince George's County has been determined as the most diverse county in Maryland, according to USA Today's Diversity Index. The index displays the chance that two people randomly selected in a place are different in both ethnicity and race. And Prince George's County is home to two of the top three highest city diversity index scores (Langley Park and Adelphi).

I would talk to Wanika Fisher. She is Prince George's County Council District 2 representative — which includes both Langley Park and Adelphi.

- Why do you feel that Langley Park and Adelphi are two of the most diverse places in Maryland?
- Is there anything you have done as the representative of both of those cities to help increase the diversity and allow people of a wide range of races to call these cities their home?

If I were to write this story, I would look for the underlying difference as to why those two places are two of most diverse places in Maryland. 
