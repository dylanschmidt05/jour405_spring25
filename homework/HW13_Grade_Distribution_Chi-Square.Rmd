...
I would say that the differences between the expected and observed frequencies are relatively meaningful. There are two grade distributions with a frequency difference of 20, which to me isn't really in the same ballpark. While the frequency difference for the grades B, D and F are considered marginal, the differences in both the A and C group are a very big, espcially considering the sample size.
...
We reject the null hypothesis, as the chi-square statistic is 11.67 while the critical value is just 9.49. 
...
The biggest margin in each grade category came from A and C, which had a difference of 20 between the observed and expected frequency. While the other grade category had a relatively small margin, it was not enough to overcome the giant gap. 

I would ask the instructor if students have usually struggled in his class in prior years because an expected frequency of just 80 students getting an A in the class out of 400 students is really low and proved to be one of the biggest differences.
