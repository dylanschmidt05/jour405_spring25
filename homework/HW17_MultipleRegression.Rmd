...
Income and percent of people with a bachelor's degree or higher is the most correlated relationship between the independent variables. The percent of population who is white has the highest correlation coefficient with the dependent variable of voter turnout. There is no correlation between the median age and the percent of people with a bachelors degree or higher. The percent of white people and the percent of unemployed people have a linear relationship with voter turnout, the latter of which has a negative correlation. There is no real linear relationship between population and the voter turnout, with the data displayed being very chaotic.
...
The multiple variable model is pretty accurate with its predictions on voter turnout, as the residual difference usually hovers right around 0. I think the unemployed percentage doesn't really play much of a factor and doesn't have any real relationship with voter turnout as we saw in the first part. Just because a person is unemployed doesn't necessarily mean they will feel compelled to have to go out and vote. However, I think the model is useful in terms of its accuracy predicting voter turnout. A median value of 0.000494 means the predictions are pretty spot on.  
...
Model 3 and Model 4 were better than the initial model by a good amount. The biggest thing I found was that the total population doesn't really play a factor in voter turnout and had the most negligible correlation value in the correlation matrix. Model 4 was the most accurate model I created, which took out population and median age. It had the best adjusted r-squared value of 0.8514. 
...
Election officials often spend large chunks of time studying the voter turnout results and looking at different factors to see their role in voter turnout. Based off the factors used above, we can make a pretty accurate prediction as to what the voter turnout is expected to be. This information allows us to get a good idea of the expected voter turnout and then look back to see what areas had the biggest difference in the model.
