...
The data is skewed a little bit to the right but it is still a normal distribution. The mean and one standard distribution tell us that most of the songs are clumped between 0.5 and 0.85 on the danceability scale. I think that the biggest storyline from this data is that the song Gunna by Lil Keed has the highest danceability score. 
