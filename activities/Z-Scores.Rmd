...
Those lines would be February 7, 2022 and February 14, 2022 which are both significantly higher than the other marks. A pattern I notice is that the highest number of drug overdoses have occured on a Wednesday which is random middle of the week day for that to happen.
...
This differs from the data in Task 3 as that data is more clustered around the mean. The call_count data from Task 5 is very spread out and fluctuates a lot. For example, there are some days with just three drug overdose calls versus some days with upwards of 23 drug overdose calls. The data doesn't really have a number in the middle of those two marks, emphasizing the point of usually quiet and unusually busy.
...
The day that is the most unusally busy is a Saturday, which makes the most sense. Saturday had an average number of 11.3 overdose calls compared to 11 per day on Friday.
...
A potential angle for my reporting would be why drug overdoses spike in August versus the other summer months. The number of drug overdoses go up from like 10.5 and 11 per day in June and July to nearly 12 per day in August. Then, the number of drug overdoses go back down the second school starts.

My next step would be to see what kinds of drugs are in the street in August versus some of those other months. Maybe there is a new drug batch that is distributed in August. I would tell my editor that the average number of drug overdoses peaks in the spring months and then August and that I will check in with the local police force to see if there is anything they suspect as to why it spikes there, maybe drug dealers are more active during those months.
