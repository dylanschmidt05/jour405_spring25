...
The mean and standard deviations of the different sample sizes drastically vary as the size gets smaller. The results from the samples of 50 and 100 are relatively close to the mean and standard deviation of the actual population. However, once the sample size got down to 10, the results were way off the numbers of the actual population.
