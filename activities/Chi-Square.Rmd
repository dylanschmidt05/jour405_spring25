...
The expected amount of movies to receive five stars is 160 but the observed number is only 145. The observed number of four star rated movies is only eight higher than the expected number of that rating, 128 to 120. The expected number of three star rated movies is seven higher than those observed totals, 80-73. Two star rated movies had the second biggest gap in expected to observed numbers, 20 to 32. The category one star rated movies had the smallest difference of only two, with 20 expected movies is 22 observed movies.
...
I would reject the null hypothesis, as the chi-square statistic of 9.95 is higher than the right-tail critical value of 9.49. While the differences in the different rating numbers isn't insanely different, the difference of both five star and two star movie rating is different enough for us to be able to reject the null hypothesis. The observed frequencies are not consistent with the expected frequencies. 
