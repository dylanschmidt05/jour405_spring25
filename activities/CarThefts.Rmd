...
The histogram displays that the data is skewed right and that this data is more clumped one standard deviation to the right versus one standard deviation to the left.
