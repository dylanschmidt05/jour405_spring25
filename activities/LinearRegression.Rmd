...
There is not really a major relationship between FARMS percentage and math test scores, as there is a giant blob of data chaotically spread around 25% FARMS percentage. However, the line of the best fit has a slight positive relationship between FARMS percentage and math test scores. 
...
I would say the model isn't really worth using because there are so many schools with the same FARMS percentage that have completely different math test scores. Therefore, predicting those schools math test scores based on their FARMS percentage won't really work. It tells us that there isn't really a relationship between FARMS percentage and math test scores, particularly because our p-value isn't significant.
...
The largest differences between the predicted result and the actual math scores is 45.82. According to the model, Whitemarsh elementary school should have around 71.93% of students meeting or exceeding the math expectations. Instead, the real number is only 26.1%, which is a quite drastic difference. Rydal West school also has a significant difference between the predicted and actual percent of students meeting or exceeding the math expectations.
...
The conclusions I would draw from this model's results is that there really isn't a relationship between fewer students on free and reduced price meals and there standardized math test scores. The model fails to show any real evidence of the school board member's claim and therefore my story pitch would focus on how the school board member's statements aren't really accurate and go in-depth with it.
