...
The dataset is pretty normal with maybe a slight skew to the left. The dataset has a few outliers on the right side but is mostly condensed around 1.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?

A respondent with a weight of 0.23 means that there is a large response total of that group so their vote is not weighed very much. However, a respondent with a weight of 3.04 means that there aren't many responses of a certain group and their vote is counted more to make that group's weight count just as much as the other ones.

3. Why might some respondents be weighted more heavily than others?

If the survey doesn't have enough responses from a certain group of people, those responses within that group will be weighted more to make each group's weight count the same in the overall survey.
...
The voter category of people who rarely/never vote have the biggest difference between weighted and unweighted results. For example, the percentage difference of that group is -3.6 while the percentage difference of the people who always vote is just -0.1.

2. How might these differences affect reporting on likely voter turnout?

These differences will give those people who rarely/never vote more weight on the report of the likely voter turnout compared to those people who always vote or sporadically vote, making the results of the survey not entirely representative of the population.
...
These differences exist because people who rarely/never vote are most likely to also not respond to surveys. This tells me that people who never/rarely vote are under-represented versus those people who always vote are over-represented.
